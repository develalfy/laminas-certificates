    ...
    private function getData($isin = null): array
    {
        return [
            'CODE-1000' => new StandardCertificate(
                ...
                new Price(500.45, new Currency('USD Dollar', '$'), '2022-06-10 00:00:01'),
            ),
            'CODE-2000' => new BonusCertificate(
                ...
                new Currency('USD Dollar', '$'),
                new Issuer('Ashraf Elalfi'),
                new Price(500.45, new Currency('USD Dollar', '$'), '2022-06-13 00:00:01'),
                12.99
            ),
            'CODE-3000' => new GuaranteeCertificate(
                ...
                new Currency('USD Dollar', '$'),
                new Issuer('Ashraf Elalfi'),
                new Price(500.45, new Currency('USD Dollar', '$'), '2022-06-25 00:00:01'),
                8
            ),
            'CODE-4000' => new GuaranteeCertificate(
                ...
                new Currency('USD Dollar', '$'),
                new Issuer('Ashraf Elalfi'),
                new Price(500.45, new Currency('USD Dollar', '$'), '2022-06-22 00:00:01'),
                7
            ),
            'CODE-5000' => new StandardCertificate(
                ...
                new Currency('USD Dollar', '$'),
                new Issuer('Ashraf Elalfi'),
                new Price(500.45, new Currency('USD Dollar', '$'), '2022-06-21 00:00:01')
            )
        ];
    }
